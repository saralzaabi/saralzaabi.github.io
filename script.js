...
button1.onclick = () =>
{
  ...
  setTimeout( () => {slide1.style.display='block'
  }, 200)
}
...
button2.onclick = () =>
{
  ...
  slide2.style.height = '700px'
  setTimeout( () => {slide2.style.display='block'
  }, 200)
}
...
{
  slide2.style.height = '0px'
  slide3.style.height = '700px'
  setTimeout( () => {slide3.style.display='block'
  }, 200)
}
